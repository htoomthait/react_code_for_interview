...
//   console.log(formData);
  ...
  const {isLoading, error, data} = useQuery({
    ...
    queryFn: async () => {
        const resp = await axios.get(`http://localhost:3000/traders?_page=${paginationModel.page}&_limit=${paginationModel.pageSize}`);
  ...
  return (
    ...
    <Dialog open={createModalOpen} onClose={handleClose}>
        ...
        <DialogContent>
          ...
          <DialogContentText>
            To create new trader record, please enter the proper form data here.
          </DialogContentText>
